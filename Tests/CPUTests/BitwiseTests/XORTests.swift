...
struct XORTests {
    ...
    @Test func testEOR_Immediate() async throws {
        ...
        for payload in payloads {
            ...
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_Immediate.rawValue
    ...
    @Test func testEOR_ZerPage() async throws {
        ...
        for payload in payloads {
            cpu.reset()
            cpu.A = payload.initialA
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_ZeroPage.rawValue
    ...
    @Test func testEOR_ZeroPageX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_ZeroPageX.rawValue
    ...
    @Test func testEOR_Absolute() async throws {
        ...
        for payload in payloads {
            cpu.reset()
            cpu.A = payload.initialA
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_Absolute.rawValue
    ...
    @Test func testEOR_AbsoluteX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_AbsoluteX.rawValue
    ...
    @Test func testEOR_AbsoluteY() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.Y = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_AbsoluteY.rawValue
            memory[Int(cpu.resetVector + 1)] = 0x78
            memory[Int(cpu.resetVector + 2)] = 0x56
            memory[0x5688] = payload.operand
    ...
    @Test func testEOR_IndirectX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x20
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_IndirectX.rawValue
    ...
    @Test func testEOR_IndirectY() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.Y = 0x20
            memory[Int(cpu.resetVector)] = Opcodes6502.EOR_IndirectY.rawValue
            memory[Int(cpu.resetVector + 1)] = 0x66
            memory[0x66] = 0x73
            memory[0x67] = 0x19
