...
struct ANDTests {
    ...
    @Test func testAND_Immediate() async throws {
        ...
        for payload in payloads {
            ...
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_Immediate.rawValue
    ...
    @Test func testAND_ZeroPage() async throws {
        ...
        for payload in payloads {
            cpu.reset()
            cpu.A = payload.initialA
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_ZeroPage.rawValue
    ...
    @Test func testAND_ZeroPageX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_ZeroPageX.rawValue
    ...
    @Test func testAND_Absolute() async throws {
        ...
        for payload in payloads {
            cpu.reset()
            cpu.A = payload.initialA
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_Absolute.rawValue
    ...
    @Test func testAND_AbsoluteX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_AbsoluteX.rawValue
    ...
    @Test func testAND_AbsoluteY() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.Y = 0x10
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_AbsoluteY.rawValue
            memory[Int(cpu.resetVector + 1)] = 0x78
            memory[Int(cpu.resetVector + 2)] = 0x56
            memory[0x5688] = payload.operand
    ...
    @Test func testAND_IndirectX() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.X = 0x20
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_IndirectX.rawValue
    ...
    @Test func testAND_IndirectY() async throws {
        ...
        for payload in payloads {
            ...
            cpu.A = payload.initialA
            cpu.Y = 0x20
            memory[Int(cpu.resetVector)] = Opcodes6502.AND_IndirectY.rawValue
            memory[Int(cpu.resetVector + 1)] = 0x66
            memory[0x66] = 0x73
            memory[0x67] = 0x19
